...
export default function AbsenceReportPage() {
  ...
  const recentReports = [
    {
      id: 1,
      title: "របាយការណ៍អវត្តមាន 15 មករា 2024",
      type: "daily",
      date: "2024-01-15",
      status: "completed",
      format: "PDF"
    ...
    {
      id: 2,
      title: "របាយការណ៍អវត្តមានខែមករា 2024",
      type: "monthly", 
      date: "2024-01-31",
      status: "completed",
      format: "Excel"
    ...
    {
      id: 3,
      title: "របាយការណ៍អវត្តមានឆ្នាំ 2023-2024",
      type: "yearly",
      date: "2024-06-30", 
      status: "pending",
      format: "PDF"
    ...
    <div>
      ...
      <div className="flex items-center justify-between space-y-6">
        <div>
          ...
          <p className="text-lg font-medium text-muted-foreground mt-3 leading-relaxed">បង្កើតរបាយការណ៍អវត្តមានសិស្ស</p>
        </div>
      </div>
                    ...
                    <TabsList className="grid w-full grid-cols-3 bg-muted/50 p-1 rounded-lg h-10">
                      ...
                      >
                        ...
                        ប្រចាំឆ្នាំ
                                          ...
                                          <div className="mt-3">
                        <TabsContent value="daily" className="space-y-2 animate-in fade-in-50 duration-200">
                          ...
                          <div className="bg-muted/30 rounded-lg p-2 border border-border/50">
                            <div className="grid grid-cols-2 gap-2">
                            <div className="space-y-1">
                              <Label htmlFor="academicYearYearly" className="text-xs font-medium">
                              ...
                              <Input
                                ...
                                onChange={(e) => setReportData({...reportData, academicYear: e.target.value})}
                                placeholder="ឧ. 2023-2024"
                                className="h-8 text-sm border-border/50 focus:border-primary focus:ring-primary/20"
                                required
                              />
                            </div>
                            <div className="space-y-1">
                              <Label htmlFor="classYearly" className="text-xs font-medium">
                                ថ្នាក់
                              </Label>
                              <Input
                                id="classYearly"
