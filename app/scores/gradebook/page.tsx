    ...
    <>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <button
          ...
          className="px-4 py-2 bg-priamry-600 text-white rounded-md hover:bg-blue-700 flex items-center"
        >
      ...
      {showReportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <Card className="w-full max-w-md">
            <CardHeader>
              <CardTitle>បង្កើតរបាយការណ៍សៀវភៅតាមដាន</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="monthly">របាយការណ៍សៀវភៅតាមដានប្រចាំខែ</option>
                      <option value="semester">របាយការណ៍សៀវភៅតាមដានប្រចាំឆមាស</option>
                      <option value="yearly">របាយការណ៍សៀវភៅតាមដានប្រចាំឆ្នាំ</option>
                    </select>
                  </div>
                  ...
                  {reportType === "semester" && (
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">ថ្ងៃចូលរៀនដំបូង</label>
                          <input
                            type="date"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">ថ្ងៃចូលរៀនចុងក្រោយ</label>
                          <input
                            type="date"
